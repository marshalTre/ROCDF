...
//    exit;
//}
while ($reg = mysqli_fetch_array($query2)or die(mysqli_error())) {
?>
...
echo strftime("%A, %d de %B de %Y") ?>
        ...
        <div class="container"></br></br></br>          
                ...
                <div class="col-md-3 col-md-offset-2">
                    <label>Tipo de organización</label></br>
                        <select name="tipo_org">
                            <option value=""></option>
                            <option value="AC" <?php if($reg["tipo_org"] == 'AC') { echo "selected";}?>>Asociación Civil</option>
                            <option value="IAP"<?php if($reg["tipo_org"] == 'IAP') { echo "selected";}?>>Institución de Asistencia Privada</option>
                            <option value="SC"<?php if($reg["tipo_org"] == 'SC') { echo "selected";}?>>Sociedad Civil</option>
                            <option value="OT"<?php if($reg["tipo_org"] == 'OT') { echo "selected";}?>>Otra</option>
                        </select></br></br>
                </div>    
            </div>
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    ...
                    <select name="delegacion">
                        <option value=""></option>
                        <option value="ALVARO OBREGON" <?php if($reg["delegacion"] == 'ALVARO OBREGON') { echo "selected";}?>>Álvaro Obregón</option>
                        <option value="AZCAPOTZALCO" <?php if($reg["delegacion"] == 'AZCAPOTZALCO') { echo "selected";}?>>Azcapotzalco</option>
                        <option value="BENITO JUAREZ" <?php if($reg["delegacion"] == 'BENITO JUAREZ') { echo "selected";}?>>Benito Juárez</option>
                        <option value="COYOACAN" <?php if($reg["delegacion"] == 'COYOACAN') { echo "selected";}?>>Coyoacán</option>
                        <option value="CUJIMALPA" <?php if($reg["delegacion"] == 'CUJIMALPA') { echo "selected";}?>>Cuajimalpa</option>
                        <option value="CUAUHTEMOC" <?php if($reg["delegacion"] == 'CUAUHTEMOC') { echo "selected";}?>>Cuauhtémoc</option>
                        <option value="GUSTAVO A. MADERO" <?php if($reg["delegacion"] == 'GUSTAVO A. MADERO') { echo "selected";}?>>Gustavo A. Madero</option>
                        <option value="IZTACALCO" <?php if($reg["delegacion"] == 'IZTACALCO') { echo "selected";}?>>Iztacalco</option>
                        <option value="IZTAPALAPA" <?php if($reg["delegacion"] == 'IZTAPALAPA') { echo "selected";}?>>Iztapalapa</option>
                        <option value="MAGDALENA CONTRERAS" <?php if($reg["delegacion"] == 'MAGDALENA CONTRERAS') { echo "selected";}?>>Magdalena Contreras</option>
                        <option value="MIGUEL HIDALGO" <?php if($reg["delegacion"] == 'MIGUEL HIDALGO') { echo "selected";}?>>Miguel Hidalgo</option>
                        <option value="MILPA ALTA" <?php if($reg["delegacion"] == 'MILPA ALTA') { echo "selected";}?>>Milpa Alta</option>
                        <option value="TLAHUAC" <?php if($reg["delegacion"] == 'TLAHUAC') { echo "selected";}?>>Tláhuac</option>
                        <option value="TLALPAN" <?php if($reg["delegacion"] == 'TLALPAN') { echo "selected";}?>>Tlalpan</option>
                        <option value="VENUSTIANO CARRANZA" <?php if($reg["delegacion"] == 'VENUSTIANO CARRANZA') { echo "selected";}?>>Venustiano Carranza</option>
                        <option value="XOCHIMILCO" <?php if($reg["delegacion"] == 'XOCHIMILCO') { echo "selected";}?>>Xochimilco</option>
                    </select></br><br>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-2">
                    ...
                    <select id="eje" name="eje_tem" onChange="mostrar(this.value);">
                        <option value=""></option>
                        <option value="1" <?php if($reg["eje_tem"] == '1') { echo "selected";}?>>Eje 1</option>
                        <option value="2" <?php if($reg["eje_tem"] == '2') { echo "selected";}?>>Eje 2</option>
                        <option value="3" <?php if($reg["eje_tem"] == '3') { echo "selected";}?>>Eje 3</option>
                        <option value="4" <?php if($reg["eje_tem"] == '4') { echo "selected";}?>>Eje 4</option>
                        <option value="5" <?php if($reg["eje_tem"] == '5') { echo "selected";}?>>Eje 5</option>
                        <option value="6" <?php if($reg["eje_tem"] == '6') { echo "selected";}?>>Eje 6</option>
                        <option value="7" <?php if($reg["eje_tem"] == '7') { echo "selected";}?>>Eje 7</option>
                        <option value="8" <?php if($reg["eje_tem"] == '8') { echo "selected";}?>>Eje 8</option>
                    </select></br></br>
                </div>
                <div class="col-md-9">
            ...
            <div class="row">
                ...
                <select id="subeje" name="sub_eje" onChange="mostrarr(this.value);">
                    <option value=""></option>
                    <option value="sub_1_1" <?php if($reg["sub_eje"] == 'sub_1_1') { echo "selected";}?>>1.1</option>
                    <option value="sub_1_2" <?php if($reg["sub_eje"] == 'sub_1_2"') { echo "selected";}?>>1.2</option>
                    <option value="sub_1_3" <?php if($reg["sub_eje"] == 'sub_1_3') { echo "selected";}?>>1.3</option>
                    <option value="sub_1_4" <?php if($reg["sub_eje"] == 'sub_1_4') { echo "selected";}?>>1.4</option>
                    <option value="sub_1_5" <?php if($reg["sub_eje"] == 'sub_1_5') { echo "selected";}?>>1.5</option>
                    <option value="sub_1_6" <?php if($reg["sub_eje"] == 'sub_1_6') { echo "selected";}?>>1.6</option>
                    <option value="sub_1_7" <?php if($reg["sub_eje"] == 'sub_1_7') { echo "selected";}?>>1.7</option>
                    <option value="sub_1_8" <?php if($reg["sub_eje"] == 'sub_1_8') { echo "selected";}?>>1.8</option>
                    <option value="sub_1_9" <?php if($reg["sub_eje"] == 'sub_1_9') { echo "selected";}?>>1.9</option>
                    <option value="sub_1_10" <?php if($reg["sub_eje"] == 'sub_1_10') { echo "selected";}?>>1.10</option>
                    <option value="sub_2_1" <?php if($reg["sub_eje"] == 'sub_2_1') { echo "selected";}?>>2.1</option>
                    <option value="sub_2_2" <?php if($reg["sub_eje"] == 'sub_2_2') { echo "selected";}?>>2.2</option>
                    <option value="sub_2_3" <?php if($reg["sub_eje"] == 'sub_2_3') { echo "selected";}?>>2.3</option>
                    <option value="sub_3_1" <?php if($reg["sub_eje"] == 'sub_3_1') { echo "selected";}?>>3.1</option>
                    <option value="sub_3_2" <?php if($reg["sub_eje"] == 'sub_3_2') { echo "selected";}?>>3.2</option>
                    <option value="sub_3_3" <?php if($reg["sub_eje"] == 'sub_3_3') { echo "selected";}?>>3.3</option>
                    <option value="sub_3_4" <?php if($reg["sub_eje"] == 'sub_3_4') { echo "selected";}?>>3.4</option>
                    <option value="sub_4_1" <?php if($reg["sub_eje"] == 'sub_4_1') { echo "selected";}?>>4.1</option>
                    <option value="sub_4_2" <?php if($reg["sub_eje"] == 'sub_4_2') { echo "selected";}?>>4.2</option>
                    <option value="sub_4_3" <?php if($reg["sub_eje"] == 'sub_4_3') { echo "selected";}?>>4.3</option>
                    <option value="sub_4_4" <?php if($reg["sub_eje"] == 'sub_4_4') { echo "selected";}?>>4.4</option>
                    <option value="sub_4_5" <?php if($reg["sub_eje"] == 'sub_4_5') { echo "selected";}?>>4.5</option>
                    <option value="sub_5_1" <?php if($reg["sub_eje"] == 'sub_5_1') { echo "selected";}?>>5.1</option>
                    <option value="sub_5_2" <?php if($reg["sub_eje"] == 'sub_5_2') { echo "selected";}?>>5.2</option>
                    <option value="sub_5_3" <?php if($reg["sub_eje"] == 'sub_5_3') { echo "selected";}?>>5.3</option>
                    <option value="sub_5_4" <?php if($reg["sub_eje"] == 'sub_5_4') { echo "selected";}?>>5.4</option>
                    <option value="sub_5_5" <?php if($reg["sub_eje"] == 'sub_5_5') { echo "selected";}?>>5.5</option>
                    <option value="sub_5_6" <?php if($reg["sub_eje"] == 'sub_5_6') { echo "selected";}?>>5.6</option>
                    <option value="sub_5_7" <?php if($reg["sub_eje"] == 'sub_5_7') { echo "selected";}?>>5.7</option>
                    <option value="sub_5_8" <?php if($reg["sub_eje"] == 'sub_5_8') { echo "selected";}?>>5.8</option>
                    <option value="sub_5_9" <?php if($reg["sub_eje"] == 'sub_5_9') { echo "selected";}?>>5.9</option>
                    <option value="sub_6_1" <?php if($reg["sub_eje"] == 'sub_6_1') { echo "selected";}?>>6.1</option>
                    <option value="sub_6_2" <?php if($reg["sub_eje"] == 'sub_6_2') { echo "selected";}?>>6.2</option>
                    <option value="sub_6_3" <?php if($reg["sub_eje"] == 'sub_6_3') { echo "selected";}?>>6.3</option>
                    <option value="sub_7_1" <?php if($reg["sub_eje"] == 'sub_7_1') { echo "selected";}?>>7.1</option>
                    <option value="sub_7_2" <?php if($reg["sub_eje"] == 'sub_7_2') { echo "selected";}?>>7.2</option>
                    <option value="sub_7_3" <?php if($reg["sub_eje"] == 'sub_7_3') { echo "selected";}?>>7.3</option>
                    <option value="sub_7_4" <?php if($reg["sub_eje"] == 'sub_7_4') { echo "selected";}?>>7.4</option>
                    <option value="sub_7_5" <?php if($reg["sub_eje"] == 'sub_7_5') { echo "selected";}?>>7.5</option>
                    <option value="sub_7_6" <?php if($reg["sub_eje"] == 'sub_7_6') { echo "selected";}?>>7.6</option>
                    <option value="sub_7_7" <?php if($reg["sub_eje"] == 'sub_7_7') { echo "selected";}?>>7.7</option>
                    <option value="sub_7_8" <?php if($reg["sub_eje"] == 'sub_7_8') { echo "selected";}?>>7.8</option>
                    <option value="sub_7_9" <?php if($reg["sub_eje"] == 'sub_7_9') { echo "selected";}?>>7.9</option>
                    <option value="sub_7_10" <?php if($reg["sub_eje"] == 'sub_7_10') { echo "selected";}?>>7.10</option>
                    <option value="sub_7_11" <?php if($reg["sub_eje"] == 'sub_7_11') { echo "selected";}?>>7.11</option>
                    <option value="sub_7_12" <?php if($reg["sub_eje"] == 'sub_7_12') { echo "selected";}?>>7.12</option>
                    <option value="sub_7_13" <?php if($reg["sub_eje"] == 'sub_7_13') { echo "selected";}?>>7.13</option>
                    <option value="sub_7_14" <?php if($reg["sub_eje"] == 'sub_7_14') { echo "selected";}?>>7.14</option>
                    <option value="sub_8_1" <?php if($reg["sub_eje"] == 'sub_8_1') { echo "selected";}?>>8.1</option>
                    <option value="sub_8_2" <?php if($reg["sub_eje"] == 'sub_8_2') { echo "selected";}?>>8.2</option>
                    <option value="sub_8_3" <?php if($reg["sub_eje"] == 'sub_8_3') { echo "selected";}?>>8.3</option>
                    <option value="sub_8_4" <?php if($reg["sub_eje"] == 'sub_8_4') { echo "selected";}?>>8.4</option>
                    <option value="sub_8_5" <?php if($reg["sub_eje"] == 'sub_8_5') { echo "selected";}?>>8.5</option>
                    <option value="sub_8_6" <?php if($reg["sub_eje"] == 'sub_8_6') { echo "selected";}?>>8.6</option>
                    <option value="sub_8_7" <?php if($reg["sub_eje"] == 'sub_8_7') { echo "selected";}?>>8.7</option>
                    <option value="sub_8_8" <?php if($reg["sub_eje"] == 'sub_8_8') { echo "selected";}?>>8.8</option>
                    <option value="sub_8_9" <?php if($reg["sub_eje"] == 'sub_8_9') { echo "selected";}?>>8.9</option>
                    <option value="sub_8_10" <?php if($reg["sub_eje"] == 'sub_8_10') { echo "selected";}?>>8.10</option>
                    <option value="sub_8_11" <?php if($reg["sub_eje"] == 'sub_8_11') { echo "selected";}?>>8.11</option>
                    <option value="sub_8_12" <?php if($reg["sub_eje"] == 'sub_8_12') { echo "selected";}?>>8.12</option>
                </select>
                </div>
        ...
        <br><br>
            ...
            <div id="del_intera">
                <div class="col-md-2">
                    <label><input type="checkbox" value="A" name="1[]" id="1"  <?php if($reg["del_intera"] == 'A') { echo "enable";}?>>Álvaro Obregón</label>
                </div>
                <div class="col-md-2">
